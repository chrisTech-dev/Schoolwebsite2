  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Tuition & <span className="text-yellow-600">Fees</span>
        </motion.h1>
      ...
      >
        <motion.div
          ...
          transition={{ delay: 0.5 }}
        >
          <FaMoneyBillWave className="text-3xl text-indigo-700 mr-4" />
      ...
      >
        ...
        >
          <div className="flex items-center mb-6">
            <FaUniversity className="text-3xl text-indigo-700 mr-4" />
            <h2 className="text-2xl md:text-3xl font-bold text-indigo-900">
              Payment Methods
            </h2>
          </div>
        ...
        >
          ...
          <motion.div
            className="mt-8 bg-indigo-800 rounded-lg p-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      >
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {tuition.otherCharges.map((charge, index) => (
                  ...
                  >
                    <td className="px-4 py-3 text-gray-700">{charge.item}</td>
        ...
        <motion.div
          className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-xl p-6 md:p-8 border border-yellow-200"
          initial={{ x: 50, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ delay: 0.9 }}
        >
          <div className="flex items-center mb-6">
            <FaPercentage className="text-3xl text-yellow-600 mr-4" />
          ...
          <div className="space-y-4">
            {tuition.discounts.map((discount, index) => (
              <motion.div
                key={index}
                className="flex items-start bg-white bg-opacity-70 rounded-lg p-4 shadow-sm"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <p className="text-yellow-900">{discount}</p>
              </motion.div>
            ))}
          </div>

          <motion.div
            className="mt-8 bg-yellow-500 bg-opacity-20 border border-yellow-300 rounded-lg p-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1.6 }}
          >
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="text-lg font-medium">Contact our Bursar:</span>
            </div>
            ...
            <div className="space-y-3">
              <p className="flex items-center">
                <span className="bg-indigo-100 text-indigo-800 rounded-full px-3 py-1 mr-3 font-medium">
                  Phone
                </span>
              ...
              <p className="flex items-center">
                ...
                <span>024 765 4321</span>
              </p>
              <p className="flex items-center">
                <span className="bg-indigo-100 text-indigo-800 rounded-full px-3 py-1 mr-3 font-medium">
                  Email
                </span>
                <span>bursar@hanvilacademy.edu.gh</span>
              </p>
              <p className="flex items-center">
                <span className="bg-indigo-100 text-indigo-800 rounded-full px-3 py-1 mr-3 font-medium">
                  Hours
        ...
        >
          ...
          <button className="text-yellow-800 font-medium hover:underline transition-colors">
